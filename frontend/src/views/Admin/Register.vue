...
<template>
  <div>
    <div>
        ...
        <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Kayıt Ol</h2>
        <p class="mt-2 text-center text-sm text-gray-600">
          Veya
          {{ ' ' }}
          <router-link :to="{name : 'Login'}" class="font-medium text-indigo-600 hover:text-indigo-500"> Hesabına Giriş Yap </router-link>
        </p>
      </div>
      <form class="mt-8 space-y-6" @submit="register">
        ...
        <div class="rounded-md shadow-sm -space-y-px">
          <div>
            <label for="fullname" class="sr-only">Ad</label>
